                ...
                <div class="bg-white rounded-lg shadow p-6 border-t-4 border-red-500">
                    ...
                    <ul class="space-y-3 list-inside list-disc text-gray-800">
                        @if ($language === 'Odia')
                            ...
                            <li>ମନ୍ଦିର ପରିସରରେ ଛେପ ପକାଇବା କିମ୍ବା ଅସଭ୍ୟ ଆଚରଣ କରିବା ନିଷିଦ୍ଧ।</li>
                            ...
                            <li>ମନ୍ଦିର ପରିସରକୁ ଛତା, ମୋବାଇଲ୍ ଫୋନ୍, ଇଲେକ୍ଟ୍ରୋନିକ୍ ଉପକରଣ, ଚମଡା ଜିନିଷ ଇତ୍ୟାଦି ସାଙ୍ଗରେ ନେଇଯିବାକୁ ନିଷିଦ୍ଧ ଅଟେ।</li>
